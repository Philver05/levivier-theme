    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'name'         => 'pam_surtitre',
                'label'        => 'Surtitre (eyebrow)',
                'type'         => 'text',
                'instructions' => 'Petit texte au-dessus du titre, ex : Commandez en ligne - Récupérez en magasin',
            ],
            [
                'key'          => 'field_pam_intro',
                'name'         => 'pam_intro',
                ...
                'type'         => 'textarea',
                'rows'         => 4,
                'instructions' => 'Paragraphe affiché sous le titre. Laissez vide pour masquer.',
            ],
