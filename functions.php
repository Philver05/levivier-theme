    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'type'          => 'url',
                'instructions'  => 'Où envoyer les clients quand ils cliquent « Commander ». Laissez vide pour garder le repli automatique (le bon Prêt à manger, où les focaccias/amarettis sont actuellement commandables). Remplissez pour rediriger ailleurs, ex : https://levivier.net/pret-a-manger/ ou une autre page.',
            ],
            [
                'key'               => 'field_famille_cta_categorie',
                'name'              => 'famille_cta_categorie',
                'label'             => 'Catégorie du bon de commande Produits Maison',
                'type'              => 'taxonomy',
                ...
                'load_terms'        => 0,
                'add_term'          => 0,
                'instructions'      => 'Utilisé seulement si le lien ci-dessus est vide ET que la page « Bon de commande — Produits Maison » est publiée. Ouvre ce bon directement sur cette catégorie.',
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'type'         => 'repeater',
                'instructions' => 'Un message s\'affiche quand le client choisit SON jour et/ou clique sur SA catégorie de produits (ex : « Les jeudis sushis » sur le jour Jeudi, ou un message qui apparaît dès qu\'on ouvre la catégorie Focaccias, sans jour précis). Vous pouvez ajouter plusieurs messages pour une même catégorie.',
                ...
                'sub_fields'   => [
                    [
                        ...
                        'type'  => 'message',
                        'message' => 'Renseignez le jour, la catégorie, ou les deux. Un seul des deux suffit à déclencher le message.',
                        'wrapper' => ['width' => '100'],
                    ],
                    [
                        'key'          => 'field_pam_msg_jour',
                        'name'         => 'msg_jour',
                        'label'        => 'Jour (optionnel)',
                        'type'         => 'select',
                        'allow_null'   => 1,
                        'instructions' => 'Laissez vide pour un message déclenché uniquement par la catégorie.',
                        'choices'      => [
                            'lundi'    => 'Lundi',
                            'mardi'    => 'Mardi',
                            'mercredi' => 'Mercredi',
