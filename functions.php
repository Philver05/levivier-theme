            ...
            [
                ...
                'sub_fields'   => [
                    ...
                    [
                        ...
                        'name'          => 'msg_categorie',
                        'label'         => 'Catégorie associée (optionnel)',
                        'type'          => 'taxonomy',
                        ...
                        'load_terms'    => 0,
                        'add_term'      => 0,
                        'instructions'  => 'Si choisie, ce message s\'affiche aussi quand on clique sur cette catégorie de produits, en plus du jour ci-dessus.',
                        'wrapper'       => ['width' => '100'],
                    ],
                    [
                    ...
                    [
                        ...
                        'name'         => 'msg_note_titre',
                        'label'        => 'Deuxième bloc — Titre (optionnel)',
                        'type'         => 'text',
                        'placeholder'  => 'Ex : Fraîcheur et conservation des sushis',
                        'instructions' => 'Pour une consigne séparée (conservation, allergènes...). Laissez vide pour n\'afficher qu\'un seul bloc.',
                        'wrapper'      => ['width' => '100'],
                    ],
                    [
                        'key'          => 'field_pam_msg_note_texte',
                        'name'         => 'msg_note_texte',
                        'label'        => 'Deuxième bloc — Texte',
                        'type'         => 'textarea',
                        'rows'         => 3,
                        'wrapper'      => ['width' => '100'],
                    ],
