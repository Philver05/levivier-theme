...
--police-accent: professor, sans-serif   ← accents décoratifs + gros titres de section
--police-titre:  "Montserrat"
--police-corps:  "Montserrat"
```
Professor (script) sur les gros titres : sous-marque Lofts, et depuis le 17 juillet aussi les noms de section principaux (Épicerie, Boutique, Produits Maison, Épicerie Africaine) via la classe `.page-entete-titre-script`, demande de Marie. Reste du texte en Montserrat. Playfair Display n'est plus utilisé.
